...
branch='master'
github_user='official-code_source_stockfish'
...
make strip
mv code_source_stockfish.exe ../../stockfish_${arch_cpu}.exe
make clean
cd
```
</details>
...
mv code_source_stockfish.exe ../../code_source_stockfish-x64${1}.exe
...
make strip COMP=mingw
mv code_source_stockfish.exe ../../code_source_stockfish-x64${1}-pgo.exe
make clean COMP=mingw
}
...
qemu-aarch64 code_source_stockfish compiler
qemu-aarch64 code_source_stockfish bench
...
# test: qemu's magic at work
qemu-arm code_source_stockfish compiler
qemu-arm code_source_stockfish bench
...
cd Stockfish/src
make -j build ARCH=armv8 COMP=gcc CXX="zig c++ -target aarch64-linux-musl"
mv code_source_stockfish.exe stockfish_armv8
```
</details>
